...
const {
  transformScalarType,
  transformInputType,
} = require('./RelayTSTypeTransformers');
...
import type {ScalarTypeMapping} from './RelayTSTypeTransformers';
...
module.exports = {
  generate: Profiler.instrument(generate, 'RelayTSGenerator.generate'),
  typescriptTransforms: TS_TRANSFORMS,
};
